...
const ContactUs = () => {
  return (
    <div className="flex-1 my-5 flex items-center justify-center p-4 ">
      <div className="bg-light-secondary dark:bg-dark-secondary p-8 rounded-lg shadow-md w-full max-w-md sm:max-w-lg md:max-w-2xl border border-light-border dark:border-dark-border">
        <h1 className="text-2xl font-bold text-light-heading dark:text-dark-heading mb-6 text-center">
          Contact Us
        </h1>
        <form>
          <div className="mb-4">
